...
para criação de classes. Funcionam como um contrato no qual o
programador, para implementar uma determinada classe, compromete-se
a desenvolver essa classe a paritir de um interface, logo, mantendo
a estrutura de métodos que esse interface declara, independentemente
da implementação de código que esse métodos depois vão ter dentro
da classe.
