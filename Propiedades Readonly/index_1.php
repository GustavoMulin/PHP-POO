...
protegida. Mas a partir do PHP 8.1 passou a ser possível a existência
de propriedades só de leitura (readonly).

A principal característica das propiedades readonly é o fato de
...
// Definir a propiedade $usuario, apesar de ser pública, gera um erro.
